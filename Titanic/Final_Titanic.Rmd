...
## 4.3 Final - Predicting the test dataset
...
Titanic dataset is a good exercise for beginner like myself to test since the dataset is not massive and a lot of people quite familiar with this tragedy. It is quite fascinating to see new insights you can get from data by applying different machine learning techniques. There are stories you can find from those insights and you can find out more on internet about some of the victims. Another thing I learnt as well, a good prediction depends on good data so do not expect to get good outcome from the best algorithms if your data is not good. In Titanic example, I believe the data is quite qood but not all factors included in the dataset. For example, cabin location is not very comprehensive and a lot of NAs in age requiring me to use average. In addition, some people were probably lucky to survive and it is not something you can factorised in your dataset. Machine learning helps provide information but sometimes it does not always give you 100% accuracy. 
